...
class PROSetState:
    ...
    def __init__(self, set, total_PROs):
        self.set = set
    ...
    def add_PRO(self, PRO):
        ...
        new_set.add(PRO)
        return PROSetState(new_set, self.total_PROs)
    ...
    def get_value(self):
        ...
        the set of PROs.
        '''
        return CANDIDATE_SPACE.get_value(PROSet(self.set))
...
class MCTSNode:
    ...
    def get_UCT(self, parent_sims, c):
        # need to change UCT cost becuase it does not work for this purpose
    ...
    def expand(self):
        ...
        next_child = MCTSNode(self.PRO_state.add_PRO(next_pro), self.tot, self.target_size, parent=self, draw_tree=True)
...
class MonteCarloSolver:
    ...
    def __init__(self, c, iters, target_set_size, total_PROs, draw_tree=False):
        '''
        @PARAMS:
        ...
        self.root = MCTSNode(PROSetState(set([]), total_PROs), total_PROs, target_set_size, draw_tree=draw_tree)
        self.draw = draw_tree
